            ...
            children: [ // Level 4
              ...
              // 1.2 Branch and Business Unit
              {
                ...
                children: [
                  ...
                  { label: 'T3', route: '/portal/admin/company/hr/branch-business-unit/t3', icon: 'label' },
                  { label: 'T4', route: '/portal/admin/company/hr/branch-business-unit/t4', icon: 'label' },
                  { label: 'Company', route: '/portal/admin/company/hr/branch-business-unit/company', icon: 'business' },
                  { label: 'Branch', route: '/portal/admin/company/hr/branch-business-unit/branch', icon: 'store' },
