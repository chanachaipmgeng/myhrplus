...
Component นี้จะแสดง:
- ปุ่มเดียว (Palette Icon) สำหรับจัดการ theme ทั้งหมด
- **Color Menu** (เมื่อคลิกปุ่ม):
  - **Theme Mode Selector**: เลือกโหมดธีม (สว่าง/มืด/อัตโนมัติ)
  - **Preset Colors**: เลือกสีธีม (8 สี)
  - **Custom Color Picker**: ปุ่ม "เลือกสีเอง" เพื่อเปิด color picker
- **Custom Color Picker**:
  - **Theme Mode Selector**: เลือกโหมดธีม (สว่าง/มืด/อัตโนมัติ)
  - **HTML5 Color Input**: เลือกสีด้วย visual color picker
  - **Hex Text Input**: ใส่ hex color code โดยตรง
  - **Color Preview**: แสดงสีที่เลือก
